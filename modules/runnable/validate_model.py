...
with no_grad():
    ...
    for i in range(TEST_EPISODE):
        ...
        test_class_1 = rn.Embed(test_class_1_inputs)
        test_class_2 = rn.Embed(test_class_2_inputs)
        ...
        train_class_1 = rn.Embed(train_class_1_inputs)
        train_class_2 = rn.Embed(train_class_2_inputs)
