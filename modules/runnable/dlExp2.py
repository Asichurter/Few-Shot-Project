...
early_stop = False
early_stop_window = 3
model_save_path = 'D:/peimages/New/class_default_exp/%s_default/' % default_class
save_path = 'D:/Few-Shot-Project/doc/dl_default_exp/'
train_set_path = 'D:/peimages/New/class_default_exp/%s_default/train/' % default_class
val_set_path = 'D:/peimages/New/class_default_exp/%s_default/validate/' % default_class
...
drawHeatmapWithGrid(conf_mat, "%s default: Resnet's confusion matrix acc=%.3f loss=%.3f"%(default_class,Acc,Loss),
